...
These are tracked-file snapshots of the former dedicated 100-days app repos.
The canonical public copy now lives in this master repo under `projects/<slug>/`.
Each project contains a `.snapshot.json` with the source remote, branch, and commit.
...
| FlagPassport | [`projects/flagpassport`](./flagpassport) | — | `8ce5b8e` |
...
| SwapCheck | [`projects/swapcheck`](./swapcheck) | — | `c8e8d5f` |
...
| VariantGuard | [`projects/variantguard`](./variantguard) | — | `a22a9d4` |
